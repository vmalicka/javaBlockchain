...
class BankingTransaction {
    ...
    // toString method creates a readable string for BankingTransaction you fucks
    @Override   // override the toString method defined in base object, to customize class, fucker
    public String toString() {
